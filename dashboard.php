...
$title = "Dashboard";
// menyertakan file untuku menampilkan notifikasi (jika ada)
    ...
    <!-- card untuk menampilkan tabel postingan -->
     <div class="card">
        <!-- tabel dengan baris yang dapat di hover -->
                            ...
                            <!-- menampilkan data dari tabel database -->
                             ...
                             while ($post = mysqli_fetch_assoc($exec)) :
                                ...
                                <div class="modal fade" id="deletePost_<?= $post['id_post']; ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="documect">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="proses_post.php" method="POST">
                                                    <div>
                                                        <p>Tidakan ini tidak bisa dibatalkan.</p>
         ...
         <!-- akhir tabel dengan garis yang dapat di hover -->
     </div>
</div>
